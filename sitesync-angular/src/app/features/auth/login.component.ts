        ...
        <div class="demo-creds">
          ...
          @for (cred of demoCreds; track cred.role) {
            <div class="demo-row" (click)="fillCred(cred)">
              <span class="demo-role" [style.color]="cred.color">{{ cred.role }}</span>
              <span class="demo-info">{{ cred.username }} / {{ cred.password }}</span>
            </div>
          }
        </div>
...
export class LoginComponent {
  ...
  demoCreds = [
    { role: 'Admin',      username: 'admin',      password: 'Admin@123',  color: '#6c63ff' },
    { role: 'Supervisor', username: 'supervisor',  password: 'Super@123',  color: '#4ecdc4' },
    { role: 'Labour',     username: 'labour',      password: 'Labour@123', color: '#43e8a0' },
  ];
